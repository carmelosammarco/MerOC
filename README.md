...
- You can copy and paste in the empty box (1) the script generated by the web portal and more specifically under the CMEMS subsetter download service related to the product of interest. However be aware that you should modify manually the login credential, file name and output folder.
